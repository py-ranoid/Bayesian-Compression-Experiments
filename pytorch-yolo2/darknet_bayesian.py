...
class Darknet(nn.Module):
    def __init__(self, cfgfile):
        ...
        self.kl_list = [self.models[0].conv1, self.models[2].conv2,self.models[4].conv3,self.models[5].conv4,self.models[6].conv5,self.models[8].conv6,self.models[9].conv7,self.models[10].conv8,self.models[12].conv9]
